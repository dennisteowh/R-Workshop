...
## 4) The stats for magikarp is wrong. It should be hp = 20, attack = 10, defense = 55, sp_atk = 15, sp_def = 20, speed = 80. Please correct it



## 5) rerun your code with the update dataset (after correcting magikarp stats). Are your answers still correct?



## 6) create a new variable in the dataset called "Attack_Mean" which is the mean of each pokemon's attack and sp_atk stats
##    for those of you who know the mean() or the rowMeans() function, you can use it. But this problem is solvable even without those functions.



## 7) I am annoyed by the Attack_Mean column name as it should be small letters like the rest of the column names. Please change it thanks. 




## 8) It is interesting to see how these pokemon would fare against each other if they battled (assume they can battle themselves too; or a clone of themselves)
